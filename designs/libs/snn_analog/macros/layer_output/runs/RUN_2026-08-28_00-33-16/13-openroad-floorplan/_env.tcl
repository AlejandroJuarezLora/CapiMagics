set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-33-16/13-openroad-floorplan/config.tracks
...
set ::env(MACRO_LEFS) /foss/designs/libs/snn_analog/lif/neurona_lvs.lef
set ::env(VDD_PIN) VDD
set ::env(GND_PIN) VSS
...
set ::env(DESIGN_NAME) layer_output
set ::env(CLOCK_PERIOD) 10
set ::env(VDD_NETS) "vdd VDD"
set ::env(GND_NETS) "vss VSS"
set ::env(DIE_AREA) "0 0 200 150"
set ::env(MACROS) "neurona_lvs \"gds /foss/designs/libs/snn_analog/lif/neurona_lvs.gds lef /foss/designs/libs/snn_analog/lif/neurona_lvs.lef instances \\\"x1 \\\\\\\"location \\\\\\\\\\\\\\\"50 50\\\\\\\\\\\\\\\" orientation N\\\\\\\" x2 \\\\\\\"location \\\\\\\\\\\\\\\"130 50\\\\\\\\\\\\\\\" orientation N\\\\\\\"\\\" vh /foss/designs/libs/snn_analog/lif/neurona_lvs.v nl \\\"\\\" pnl \\\"\\\" spef \\\"\\\" lib \\\"\\\\\\\"*\\\\\\\" /foss/designs/libs/snn_analog/lif/neurona_lvs.lib\\\" spice /foss/designs/libs/snn_analog/lif/neurona_lvs.spice sdf \\\"\\\" json_h None\""
set ::env(EXTRA_LEFS) /foss/designs/libs/snn_analog/lif/neurona_lvs.lef
set ::env(EXTRA_GDS) /foss/designs/libs/snn_analog/lif/neurona_lvs.gds
...
set ::env(PDN_MACRO_CONNECTIONS) "\"x1 vdd vss vdd vss\" \"x2 vdd vss vdd vss\""
...
set ::env(CURRENT_NL) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-33-16/06-yosys-synthesis/layer_output.nl.v
set ::env(SAVE_ODB) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-33-16/13-openroad-floorplan/layer_output.odb
set ::env(SAVE_DEF) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-33-16/13-openroad-floorplan/layer_output.def
set ::env(SAVE_SDC) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-33-16/13-openroad-floorplan/layer_output.sdc
set ::env(SAVE_NL) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-33-16/13-openroad-floorplan/layer_output.nl.v
set ::env(SAVE_PNL) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-33-16/13-openroad-floorplan/layer_output.pnl.v
