...
set ::env(PDN_VSPACING) 2
set ::env(PDN_HSPACING) 2
set ::env(PDN_VPITCH) 75
set ::env(PDN_HPITCH) 75
set ::env(PDN_VOFFSET) 16.32
set ::env(PDN_HOFFSET) 16.65
set ::env(PDN_CORE_RING_VWIDTH) 1.5
set ::env(PDN_CORE_RING_HWIDTH) 1.5
...
set ::env(CURRENT_ODB) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-38-47/18-openroad-cutrows/layer_output.odb
set ::env(SAVE_ODB) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-38-47/20-openroad-generatepdn/layer_output.odb
set ::env(SAVE_DEF) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-38-47/20-openroad-generatepdn/layer_output.def
set ::env(SAVE_SDC) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-38-47/20-openroad-generatepdn/layer_output.sdc
set ::env(SAVE_NL) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-38-47/20-openroad-generatepdn/layer_output.nl.v
set ::env(SAVE_PNL) /foss/designs/libs/snn_analog/macros/layer_output/runs/RUN_2026-08-28_00-38-47/20-openroad-generatepdn/layer_output.pnl.v
