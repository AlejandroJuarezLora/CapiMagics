set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/13-openroad-floorplan/config.tracks
...
set ::env(PDN_MACRO_CONNECTIONS) "\"x1 vdd vss vdd vss\" \"x2 vdd vss vdd vss\" \"x3 vdd vss vdd vss\" \"x4 vdd vss vdd vss\""
...
set ::env(CURRENT_NL) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/06-yosys-synthesis/layer_input.nl.v
set ::env(SAVE_ODB) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/13-openroad-floorplan/layer_input.odb
set ::env(SAVE_DEF) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/13-openroad-floorplan/layer_input.def
set ::env(SAVE_SDC) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/13-openroad-floorplan/layer_input.sdc
set ::env(SAVE_NL) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/13-openroad-floorplan/layer_input.nl.v
set ::env(SAVE_PNL) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/13-openroad-floorplan/layer_input.pnl.v
