set ::env(PL_TARGET_DENSITY_PCT) 37.688800
...
set ::env(CURRENT_ODB) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/25-odb-customioplacement/layer_input.odb
set ::env(SAVE_ODB) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/27-openroad-globalplacement/layer_input.odb
set ::env(SAVE_DEF) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/27-openroad-globalplacement/layer_input.def
set ::env(SAVE_SDC) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/27-openroad-globalplacement/layer_input.sdc
set ::env(SAVE_NL) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/27-openroad-globalplacement/layer_input.nl.v
set ::env(SAVE_PNL) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/27-openroad-globalplacement/layer_input.pnl.v
