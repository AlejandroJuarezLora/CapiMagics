...
set ::env(CURRENT_ODB) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/18-openroad-cutrows/layer_input.odb
set ::env(SAVE_ODB) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/20-openroad-generatepdn/layer_input.odb
set ::env(SAVE_DEF) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/20-openroad-generatepdn/layer_input.def
set ::env(SAVE_SDC) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/20-openroad-generatepdn/layer_input.sdc
set ::env(SAVE_NL) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/20-openroad-generatepdn/layer_input.nl.v
set ::env(SAVE_PNL) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/20-openroad-generatepdn/layer_input.pnl.v
