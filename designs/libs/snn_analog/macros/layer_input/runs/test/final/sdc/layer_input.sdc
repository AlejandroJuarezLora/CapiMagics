...
set_driving_cell -lib_cell gf180mcu_as_sc_mcu7t3v3__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {Iext1}]
set_driving_cell -lib_cell gf180mcu_as_sc_mcu7t3v3__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {Iext2}]
set_driving_cell -lib_cell gf180mcu_as_sc_mcu7t3v3__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {Iext3}]
set_driving_cell -lib_cell gf180mcu_as_sc_mcu7t3v3__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {Iext4}]
###############################################################################
# Design Rules
###############################################################################
