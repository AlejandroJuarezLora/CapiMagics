...
Group{
	...
	Contact = Region[3];
	Dielec_Contact = Region[4];
	Poly = Region[5];
	Dielec_Poly = Region[6];
	Active = Region[7];
	...
	Via_3 = Region[19];
	Dielec_Via_3 = Region[20];
	Metal_4 = Region[21];
	Dielec_Metal_4 = Region[22];
	Via_4 = Region[23];
	Dielec_Via_4 = Region[24];
	Metal_5 = Region[25];
	Dielec_Metal_5 = Region[26];
	influx = Region[27];
	fixtemp = Region[28];
	Vol_The = Region[{N-Well, Dielec_N-Well, Contact, Dielec_Contact, Poly, Dielec_Poly, Active, Dielec_Active, Metal_1, Dielec_Metal_1, Via_1, Dielec_Via_1, Metal_2, Dielec_Metal_2, Via_2, Dielec_Via_2, Metal_3, Dielec_Metal_3, Via_3, Dielec_Via_3, Metal_4, Dielec_Metal_4, Via_4, Dielec_Via_4, Metal_5, Dielec_Metal_5}];
	...
	k[Via_4] = kVia / 0.000001;
	k[Dielec_Via_4] = kDielecVia / 0.000001;
	rhoc[Via_4] = rhocVia; 
	rhoc[Dielec_Via_4] = rhocDielecVia; 
	k[Metal_5] = kMetal / 0.000001;
	k[Dielec_Metal_5] = kDielecMetal / 0.000001;
	rhoc[Metal_5] = rhocMetal; 
	rhoc[Dielec_Metal_5] = rhocDielecMetal; 

	TimeFct[] = ($Time < pulse) ? 1 : 0;

	Flux[] = Pmax / 4.77282e-10 * TimeFct[];       // Power density [W/m^2]
	qVol[] = 0;
	t0 = 0;
	t1 = timemax;
	dt = dtime;
