...
set ::env(CURRENT_NL) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/40-openroad-detailedrouting/layer_input.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /foss/designs/libs/snn_analog/macros/layer_input/runs/test/49-openroad-rcx/nom/layer_input.nom.spef \"min_*\" /foss/designs/libs/snn_analog/macros/layer_input/runs/test/49-openroad-rcx/min/layer_input.min.spef \"max_*\" /foss/designs/libs/snn_analog/macros/layer_input/runs/test/49-openroad-rcx/max/layer_input.max.spef"
set ::env(CURRENT_ODB) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/48-odb-cellfrequencytables/layer_input.odb
set ::env(SAVE_SDC) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/50-openroad-stapostpnr/layer_input.sdc
