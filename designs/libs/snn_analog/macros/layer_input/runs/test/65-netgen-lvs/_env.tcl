...
set ::env(CURRENT_SPICE) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/63-magic-spiceextraction/layer_input.spice
set ::env(CURRENT_PNL) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/40-openroad-detailedrouting/layer_input.pnl.v
