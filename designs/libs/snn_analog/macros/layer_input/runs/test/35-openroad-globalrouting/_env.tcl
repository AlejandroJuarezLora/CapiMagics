...
set ::env(CURRENT_ODB) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/32-openroad-detailedplacement/layer_input.odb
set ::env(SAVE_ODB) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/35-openroad-globalrouting/layer_input.odb
set ::env(SAVE_DEF) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/35-openroad-globalrouting/layer_input.def
