...
set ::env(CURRENT_ODB) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/17-odb-manualmacroplacement/layer_input.odb
set ::env(SAVE_ODB) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/18-openroad-cutrows/layer_input.odb
set ::env(SAVE_DEF) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/18-openroad-cutrows/layer_input.def
