...
set ::env(CURRENT_DEF) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/48-odb-cellfrequencytables/layer_input.def
...
set ::env(SAVE_SPEF) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/49-openroad-rcx/min/layer_input.min.spef
