...
set ::env(CURRENT_ODB) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/35-openroad-globalrouting/layer_input.odb
set ::env(SAVE_ODB) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/38-openroad-repairantennas/1-openroad-diodeinsertion/layer_input.odb
set ::env(SAVE_DEF) /foss/designs/libs/snn_analog/macros/layer_input/runs/test/38-openroad-repairantennas/1-openroad-diodeinsertion/layer_input.def
