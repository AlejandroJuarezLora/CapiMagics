set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/libs/snn_analog/macros/stdp_4x2/runs/test/21-openroad-floorplan/config.tracks
...
set ::env(PDN_MACRO_CONNECTIONS) "\".*x.* avdd avss VDD VSS\""
...
set ::env(CURRENT_NL) /foss/designs/libs/snn_analog/macros/stdp_4x2/runs/test/14-yosys-synthesis/stdp_4x2.nl.v
set ::env(SAVE_ODB) /foss/designs/libs/snn_analog/macros/stdp_4x2/runs/test/21-openroad-floorplan/stdp_4x2.odb
set ::env(SAVE_DEF) /foss/designs/libs/snn_analog/macros/stdp_4x2/runs/test/21-openroad-floorplan/stdp_4x2.def
set ::env(SAVE_SDC) /foss/designs/libs/snn_analog/macros/stdp_4x2/runs/test/21-openroad-floorplan/stdp_4x2.sdc
set ::env(SAVE_NL) /foss/designs/libs/snn_analog/macros/stdp_4x2/runs/test/21-openroad-floorplan/stdp_4x2.nl.v
set ::env(SAVE_PNL) /foss/designs/libs/snn_analog/macros/stdp_4x2/runs/test/21-openroad-floorplan/stdp_4x2.pnl.v
